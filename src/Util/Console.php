...
namespace Arjeta\Util;

/**
 * @method static red($string)
 * @method static black($string)
 * @method static bold($string)
 * @method static blue($string)
 * @method static green($string)
 * @method static cyan($string)
 * @method static yellow($string)
 */
class Console {
